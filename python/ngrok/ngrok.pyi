...
def connect(addr: Union[None,str,int]=None, tunnel: Optional[NgrokTunnel]=None, **options: object) -> NgrokTunnel: ...
...
def kill() -> None: ...
def listen(server: Optional[Any]=None, tunnel: Optional[NgrokTunnel]=None) -> NgrokTunnel: ...
def log_level(level: str='INFO') -> None: ...
def pipe_name() -> str: ...
def werkzeug_develop(tunnel: Optional[NgrokTunnel]=None) -> Union[Awaitable[NgrokTunnel],NgrokTunnel]: ...
...
class NgrokSessionBuilder:
    ...
    def client_info(self, client_type: str, version: str, comments: Optional[str]=None) -> NgrokSessionBuilder: ...
    def connect(self) -> Awaitable[NgrokSession]: ...
    def handle_disconnection(self, handler: Callable[[str, str]]) -> NgrokSessionBuilder: ...
    ...
    def handle_update_command(self, handler: Callable[[str, str]]) -> NgrokSessionBuilder: ...
...
class NgrokHttpTunnelBuilder:
    ...
    def oauth(self, provider: str, allow_emails: Optional[str]=None, allow_domains: Optional[str]=None, scopes: Optional[str]=None) -> NgrokHttpTunnelBuilder: ...
    def oidc(self, issuer_url: str, client_id: str, client_secret: str, \
        allow_emails: Optional[str]=None, allow_domains: Optional[str]=None, scopes: Optional[str]=None) -> NgrokHttpTunnelBuilder: ...
    ...
    def webhook_verification(self, provider: str, secret: str) -> NgrokHttpTunnelBuilder: ...
...
class NgrokTlsTunnelBuilder:
    ...
    def termination(self, cert_pem: bytearray, key_pem: bytearray) -> NgrokTlsTunnelBuilder: ...
